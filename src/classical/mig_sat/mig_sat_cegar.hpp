 ...
 * @file mign.hpp
 *
 * @brief New approach for MIG- exact synthesis - Based on Knuth, The Art of COmputer Programming 
 * Based on the work proposed in by Soeken et al. DATE 2017
 *
 * @author Eleonora Testa
 * @since  2.3
 */

#ifndef MIG_SAT_CEGAR_HPP
#define MIG_SAT_CEGAR_HPP
